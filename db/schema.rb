...
ActiveRecord::Schema.define(version: 20171030094107) do
  ...
  add_index "custom_values", ["customized_type", "customized_id", "custom_field_id"], name: "index_custom_values_ccc"
  ...
  create_table "glossary_styles", force: :cascade do |t|
    t.boolean "show_desc",     default: false
    t.integer "groupby",       default: 1
    t.integer "project_scope", default: 0
    t.string  "sort_item_0",   default: ""
    t.string  "sort_item_1",   default: ""
    t.string  "sort_item_2",   default: ""
  ...
  create_table "news", force: :cascade do |t|
    ...
    t.boolean  "uncommentable",              default: false
  end
  ...
  create_table "terms", force: :cascade do |t|
    ...
    t.string   "datatype",    default: ""
    t.string   "codename",    default: ""
    t.text     "description"
    t.datetime "created_on"
    t.datetime "updated_on"
    t.string   "rubi",        default: ""
    t.string   "abbr_whole",  default: ""
    t.string   "tech_en",     default: ""
    t.string   "name_cn",     default: ""
    t.string   "name_fr",     default: ""
  end
  ...
  create_table "wiki_extensions_comments", force: :cascade do |t|
  ...
  create_table "wiki_extensions_counts", force: :cascade do |t|
    t.integer "project_id"
    t.integer "page_id"
    t.date    "date"
    t.integer "count"
  ...
  create_table "wiki_extensions_menus", force: :cascade do |t|
    t.integer "project_id"
    t.integer "menu_no"
    t.string  "page_name"
    t.string  "title"
  ...
  create_table "wiki_extensions_settings", force: :cascade do |t|
    t.integer  "project_id"
    t.datetime "created_at"
    t.datetime "updated_at"
  ...
  create_table "wiki_extensions_tag_relations", force: :cascade do |t|
    t.integer  "tag_id"
    t.integer  "wiki_page_id"
    t.datetime "created_at"
  end
  ...
  create_table "wiki_extensions_tags", force: :cascade do |t|
    t.integer  "project_id"
    t.string   "name"
    t.datetime "created_at"
  end

  create_table "wiki_extensions_votes", force: :cascade do |t|
    t.string  "keystr"
  ...
  create_table "wiki_page_tags", id: false, force: :cascade do |t|
    t.integer "id"
    t.string  "tag"
    t.integer "wiki_page_id"
  end
